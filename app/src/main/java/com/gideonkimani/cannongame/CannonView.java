...
public class CannonView extends SurfaceView
    ...
    private Activity activity; // to display Game Over dialog in games threads
    ...
    private void showGameOverDialog(final int messageId) {
        ...
        builder.setTitle(getResources().getString(R.string.results_format, shotsFired, totalElapsedTime));
